...
class ApplyTexture:
    def __init__(self, vehicle_type, data_dir, texts, img_size, texture_size, faces, vertices, distence=None, mask_dir='', ret_mask=False):
    ...
    def apply(self, file_name):
        ...
        eye, camera_direction, camera_up = nmr.get_params(self.vehicle_type, cam_trans, veh_trans)
...
class DatasetAdv(Dataset):
    def __init__(self, vehicle_type, data_dir, texts, img_size, texture_size, faces, vertices, distence=None, mask_dir=None, ret_mask=False):
        self.vehicle_type = vehicle_type    
        self.data_dir = data_dir
        self.files = []
