...
def parse_args():
    ...
    parser.add_argument(
        '--config', default='/root/ovd-attack/YOLO-World/configs/pretrain/yolo_world_v2_l_vlpan_bn_2e-3_100e_4x8gpus_obj365v1_goldg_train_1280ft_lvis_minival.py', help='test config file path')
    parser.add_argument(
        '--checkpoint', default='/root/ovd-attack/weights/yolo_world/yolo_world_v2_l_obj365v1_goldg_pretrain_1280ft-9babe3f6.pth', help='checkpoint file')
    parser.add_argument('--image', default='/root/ovd-attack/YOLO-World/demo/sample_images/bus.jpg',
