...
def find_noun_phrases(caption: str) -> list:
    ...
    try:
        ...
        nltk.download('averaged_perceptron_tagger',
                      download_dir='~/nltk_data', quiet=True)
    except ImportError:
...
class GLIP(SingleStageDetector):
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        new_text_prompts = []
        positive_maps = []
        # print('text_prompts:', set(text_prompts))
    ...
    def predict(self,
        ...
        if isinstance(text_prompts[0], list):
            ...
            results_list = self.bbox_head.predict(
                ...
                batch_data_samples,
                rescale=rescale)
            # print(f"type: {type(self.bbox_head)}")
            # print(f"results_list: {results_list[0]['scores'].requires_grad}")
        ...
        for data_sample, pred_instances, entity in zip(batch_data_samples,
            ...
            # print(
            #     f"/root/ovd-attack/mmdetection/mmdet/models/detectors/glip.py: {data_sample.pred_instances['scores'].requires_grad}")
