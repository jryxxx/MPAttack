...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='/root/ovd-attack/dataset_cod/cod_resnet50_ugtr.yaml', help='config file')
...
def main():
    ...
    for image in images:
        args.save_folder = f'/root/ovd-attack/dataset_cod/results_ugtr/{image}'
        save_folder = args.save_folder
        check_makedirs(save_folder)
    
        # gray_folder = os.path.join(save_folder, 'pred')
        gray_folder = save_folder
